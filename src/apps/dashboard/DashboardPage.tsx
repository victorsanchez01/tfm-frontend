      ...
      <main className={styles.main}>
        ...
        <div className={styles.cardGrid}>
          ...
          <DashboardCard
            ...
            description="Tu ruta personalizada generada con IA"
            buttonText="Ver mi plan"
            onButtonClick={() => navigate('/learning-plan')}
          />
          ...
          <DashboardCard
            ...
            description="Tu progreso por habilidad evaluada"
            buttonText="Ver mi mastery"
            onButtonClick={() => navigate('/mastery')}
          />
